...
import { brandLogin } from "@/lib/adminStore";
      ...
      <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
        <div className="glow-card rounded-2xl p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-2xl font-bold mb-2 text-foreground">Brand Login</h1>
            <p className="text-sm text-muted-foreground">Sign in to your brand dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="brand@email.com" className="pl-10 bg-background border-border" required />
              </div>
            </div>
            <div className="space-y-2">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Don't have an account? <Link to="/brand-register" className="text-primary hover:underline">Create one</Link>
          </p>
        </div>
      </motion.div>
    </div>
